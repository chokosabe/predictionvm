    ...
    useEffect(() => {
        const checkServices = async () => {
            ...
            try {
                ...
                console.error("VM API check failed. Message:", e?.message, "Stack:", e?.stack, "Full error:", e);
            ...
            try {
                ...
                console.error("Core API check failed. Message:", e?.message, "Stack:", e?.stack, "Full error:", e);
